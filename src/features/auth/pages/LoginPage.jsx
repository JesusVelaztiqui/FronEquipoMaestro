...
const LoginPage = () => {
  const [usuario, setUsuario] = useState({
    email: "jesusvelaztiqui11@gmail.com",
    pass: "123",
  });

  const funcioningresar = async () => {
    try {
      ...
      <div className="left-panel">
        <div className="header">
          ...
          <div className="auth-buttons">
            <button className="sign-up-btn">Crear Cuenta</button>
            <button className="join-us-btn">Iniciar Sesión</button>
          </div>
        </div>
        ...
        <div className="login-form-container">
          <div className="login-form">
            ...
            <div className="form-fields">
              ...
              <button className="login-btn" onClick={() => funcioningresar()}>
                Ingresar
              </button>
            </div>

            <p className="signup-text">
              Siguenos en nuestras redes sociales <a href="#">estaras al día</a>
            </p>
